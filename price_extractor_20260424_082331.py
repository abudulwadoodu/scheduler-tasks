...
Implements robust extraction for the observed format: 'Now £<amount> inc. VAT'.
"""
...
def extract_price_with_tax(text_content: str) -> ExtractedPrice:
    ...
    """
    # Regex: Now <currency><amount> inc. VAT (case-insensitive, optional period, flexible whitespace)
    pattern = re.compile(
...
def extract_price_without_tax(text_content: str) -> ExtractedPrice:
    """
    No price without tax is present in the observed data.
    """
