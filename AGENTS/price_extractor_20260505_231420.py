...
Implements NotImplementedError for pages where price elements are not identified in the DOM.
"""
...
def extract_price_with_tax(text_content: str) -> ExtractedPrice:
    ...
    Raises NotImplementedError if the price type was not identified for this page.
    """
...
if __name__ == '__main__':
    ...
    try:
        print(extract_price_with_tax('Inc. VAT: £17.04'))
    except NotImplementedError as e:
        print(f'With-tax extraction: {e}')
    try:
        print(extract_price_without_tax('Ex. VAT: £14.20'))
    except NotImplementedError as e:
