...
try:
    r.xgroup_create("urls1", GROUP, id="0", mkstream=True)
...
while True:
    ...
    messages = r.xreadgroup(GROUP, CONSUMER, {"urls1": "0"}, count=10, block=1000)
    #print('[extractor] Pending messages fetched:', messages)

    if not messages or not messages[0][1]:
        #print("[extractor] reading new messages...")
        messages = r.xreadgroup(GROUP, CONSUMER, {"urls1": ">"}, block=5000)
